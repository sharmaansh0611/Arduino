...
void send_sms(){
  sim800L.print("AT+CMGS=\"+918955393300\"\r");
  waitForResponse();
  
  sim800L.print("https://maps.google.com/maps?q=loc:28.519158558284275,77.3654082559462");
  sim800L.write(0x1A);
  waitForResponse();
}
...
void make_call(){
  sim800L.println("ATD+918955393300;");
  waitForResponse();
}
...
The value in the information response, 12, is thse message reference number allocated to the SMS 
